  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page)" }}>
      <AdminHeader
        ...
        subtitle={userFilter ? "Conversaciones de un usuario." : "Historial de chats de usuarios registrados e invitados."}
      >
        {userFilter && (
          <button onClick={() => router.push("/admin/conversations")} className="admin-back-link" style={{ marginTop: 8, marginLeft: 11, background: "none", cursor: "pointer" }}>
            Ver todas →
          </button>
        )}
      </AdminHeader>
